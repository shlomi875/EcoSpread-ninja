...
import { Edit2, ExternalLink, Image as ImageIcon, Search, Trash2 } from 'lucide-react';
...
export function Spreadsheet({ data, onEdit, onDelete, searchQuery, onSearchChange, language, role }: SpreadsheetProps) {
