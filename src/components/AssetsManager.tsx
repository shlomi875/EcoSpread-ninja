...
const INITIAL_ASSETS: Asset[] = [
  { id: '1', name: 'Banner_Summer_Sale.jpg', type: 'image', category: 'banner', size: '2.4 MB', date: '2026-04-01', url: 'https://picsum.photos/seed/banner1/800/400', brand: 'Tissot' },
  { id: '2', name: 'Product_Watch_01.png', type: 'image', category: 'product', size: '1.2 MB', date: '2026-03-28', url: 'https://picsum.photos/seed/watch1/400/400', brand: 'Tissot', model: 'Gentleman' },
  { id: '3', name: 'Instagram_Story_Promo.mp4', type: 'video', category: 'social', size: '15.8 MB', date: '2026-03-25', url: 'https://picsum.photos/seed/video1/400/800', brand: 'Casio' },
  { id: '4', name: 'Logo_EcoSpread_White.svg', type: 'vector', category: 'logo', size: '45 KB', date: '2026-03-20', url: 'https://picsum.photos/seed/logo1/200/200' },
];
            ...
            >
              <div className="aspect-square relative overflow-hidden bg-gray-50">
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                  ...
                  <button className="p-3 bg-white rounded-xl text-red-500 hover:bg-red-50 transition-all">
